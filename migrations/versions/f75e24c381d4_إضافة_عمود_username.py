...
Revision ID: f75e24c381d4
Revises: 8b1036f44eed
Create Date: 2025-03-04 05:38:26.183106
...
revision = 'f75e24c381d4'
down_revision = '8b1036f44eed'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('username', sa.String(length=100), nullable=True))  # السماح بالقيم الفارغة مؤقتًا
    ...
    # ✅ تحديث جميع المستخدمين الحاليين لإعطائهم قيمة `username` مساوية لبريدهم الإلكتروني
