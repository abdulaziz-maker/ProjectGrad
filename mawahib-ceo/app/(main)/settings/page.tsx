    ...
    <div className="space-y-6 max-w-3xl animate-fade-in-up" dir="rtl">
      ...
      <div className="card-static overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
          ...
          <button onClick={() => setShowAddBatch(!showAddBatch)}
            ...
            style={showAddBatch ? { color: '#dc2626', backgroundColor: '#fef2f2' } : { color: '#6366f1', backgroundColor: 'rgba(99,102,241,0.06)' }}>
          ...
          {([
            ...
            <div key={item.key} className="flex items-center justify-between py-2">
              ...
              <button
                ...
                style={notifications[item.key] ? { backgroundColor: '#6366f1' } : undefined}
              >
      ...
      <div className="card-static rounded-2xl p-5">
        <div className="flex items-start gap-3">
          <Info className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: '#6366f1' }} />
          <div>
