        ...
        <div className="flex flex-col items-center gap-7">
          <div className="book-loader-wrap">
            <svg width="88" height="72" viewBox="0 0 88 72" fill="none" xmlns="http://www.w3.org/2000/svg">
              <ellipse cx="44" cy="40" rx="32" ry="18" fill="rgba(192,138,72,0.18)" className="book-open-glow" />
              <g className="book-cover-left">
                <rect x="4" y="10" width="36" height="52" rx="3" fill="#1A1B20" stroke="#C08A48" strokeWidth="1.5" />
              ...
              <g className="book-pages">
                <line x1="8"  y1="24" x2="40" y2="24" stroke="#356B6E" strokeOpacity="0.5" strokeWidth="0.8" />
                <line x1="8"  y1="30" x2="40" y2="30" stroke="#356B6E" strokeOpacity="0.4" strokeWidth="0.8" />
                <line x1="8"  y1="36" x2="40" y2="36" stroke="#356B6E" strokeOpacity="0.4" strokeWidth="0.8" />
                <line x1="8"  y1="42" x2="36" y2="42" stroke="#356B6E" strokeOpacity="0.3" strokeWidth="0.8" />
                <line x1="48" y1="24" x2="80" y2="24" stroke="#356B6E" strokeOpacity="0.5" strokeWidth="0.8" />
                <line x1="48" y1="30" x2="80" y2="30" stroke="#356B6E" strokeOpacity="0.4" strokeWidth="0.8" />
                <line x1="48" y1="36" x2="80" y2="36" stroke="#356B6E" strokeOpacity="0.4" strokeWidth="0.8" />
                <line x1="48" y1="42" x2="72" y2="42" stroke="#356B6E" strokeOpacity="0.3" strokeWidth="0.8" />
              </g>
              ...
              <g className="book-cover-right">
                <rect x="48" y="10" width="36" height="52" rx="3" fill="#1A1B20" stroke="#C08A48" strokeWidth="1.5" />
              ...
              <ellipse cx="44" cy="68" rx="24" ry="3" fill="rgba(192,138,72,0.15)" />
            </svg>
          </div>
